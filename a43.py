...
def main():
    ...
    num_shapes = (GenRandom(100, 10000)) # number of shapes we want in the artwork, randomly generated by GenRandom class, more will make the image more full of shapes and colourful!

    writeHTMLfile(num_shapes.random) # write HMTL file with the number of shapes stated 
